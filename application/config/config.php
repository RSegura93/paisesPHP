...
|
*/
if (isset($_ENV["OPENSHIFT_APP_DNS"]))
	$root_base = 'http://' . getenv('OPENSHIFT_APP_DNS') . '/';
else
	$root_base = "http://".$_SERVER['HTTP_HOST'];

$ark_root  = $root_base;
$ark_root .= str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
$config['base_url']	= $ark_root;

// define('HTTP_ASSETS_PATH_ADMIN', $config['base_url'].'extra_files/');
